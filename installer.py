...
os.mkdir(DEFAULT_PATH + "\\python-3.13.12-embed-amd64\\Lib\\ESP-scripts")
shutil.copyfile(DEFAULT_PATH + "\\ESP-scripts\\demomunk.py", DEFAULT_PATH + "\\python-3.13.12-embed-amd64\\Lib\\ESP-scripts\\demomunk.py")